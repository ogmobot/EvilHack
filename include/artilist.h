...
STATIC_OVL NEARDATA struct artifact artilist[] = {
    ...
    A("Ogresmasher", HEAVY_WAR_HAMMER, (SPFX_RESTR | SPFX_WARN | SPFX_DCLAS), 0, MH_OGRE,
      PHYS(5, 5), NO_DFNS, NO_CARY, 0, A_NONE, NON_PM, NON_PM, 500L,
      NO_COLOR),

    A("Trollsbane", MORNING_STAR, (SPFX_RESTR | SPFX_WARN | SPFX_DCLAS | SPFX_REGEN), 0, MH_TROLL,
