...
NEARDATA struct permonst mons[] = {
    ...
    MON("warg", S_DOG, LVL(7, 12, 4, 0, -5), (G_GENO | G_SGROUP | 2),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE | M2_DOMESTIC,
    ...
    MON("magical eye", S_EYE, LVL(9, 6, 0, 90, -10), (2),
        ...
        M3_SKITTISH | M3_INFRAVISIBLE | M3_INFRAVISION, 0, 0, 14, HI_LORD),
    /*
     * felines
     */
    MON("kitten", S_FELINE, LVL(2, 18, 6, 0, 0), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE, 0, 0, 3, HI_DOMESTIC),
    ...
    MON("hobbit rogue", S_HUMANOID, LVL(2, 9, 8, 0, 1), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_SITM, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 200, MS_HUMANOID, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("dwarf", S_HUMANOID, LVL(2, 6, 10, 10, 4), (G_GENO | 3),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, MH_DWARF, 4, CLR_RED),
    MON("bugbear", S_HUMANOID, LVL(3, 9, 5, 0, -6), (G_GENO | 1),
        ...
        M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE | M3_INFRAVISION, 0, 0, 5, CLR_BROWN),
    ...
    MON("dwarf lady", S_HUMANOID, LVL(4, 6, 10, 10, 5), (G_GENO | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(900, 300, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_TUNNEL | M1_NEEDPICK | M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("dwarf queen", S_HUMANOID, LVL(6, 6, 10, 20, 6), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(900, 300, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_TUNNEL | M1_NEEDPICK | M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("kobold lady", S_KOBOLD, LVL(2, 6, 10, 0, -4), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 200, MS_ORC, MZ_SMALL), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_OMNIVORE,
        M2_HOSTILE | M2_LORD | M2_FEMALE | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, 0, 3, HI_LORD),
    ...
    MON("mumak", S_QUADRUPED, LVL(5, 9, 0, 0, -2), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE, 0, 0, 7, CLR_GRAY),
    ...
    MON("giant spider", S_SPIDER, LVL(5, 15, 4, 0, 0), (G_GENO | 1),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_POIS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG, 0, 0, 0, 7, CLR_MAGENTA),
    ...
    MON("plains centaur", S_CENTAUR, LVL(4, 18, 4, 0, 0), (G_GENO | 1),
        ...
        SIZ(2500, 500, MS_HUMANOID, MZ_LARGE), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_STRONG | M2_GREEDY | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE | M3_SKITTISH, 0, MH_CENTAUR, 6, CLR_BROWN),
    MON("forest centaur", S_CENTAUR, LVL(5, 18, 3, 10, -1), (G_GENO | 1),
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_STRONG | M2_GREEDY | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE | M3_SKITTISH, 0, MH_CENTAUR, 8, CLR_GREEN),
    MON("mountain centaur", S_CENTAUR, LVL(6, 20, 2, 10, -3), (G_GENO | 1),
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_STRONG | M2_GREEDY | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE | M3_SKITTISH, 0, MH_CENTAUR, 9, CLR_CYAN),
    /*
     * Dragons
     */
    ...
    MON("baby white dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 3, 8), ATTK(AT_CLAW, AD_PHYS, 2, 4),
          ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_NONE, AD_COLD, 0, 2),
          NO_ATTK, NO_ATTK),
    ...
    MON("baby green dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 3, 8), ATTK(AT_CLAW, AD_PHYS, 2, 4),
          ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_NONE, AD_DRST, 0, 2),
          NO_ATTK, NO_ATTK),
    ...
    MON("white dragon", S_DRAGON, LVL(15, 9, -1, 20, -5), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_COLD, 4, 6), ATTK(AT_BITE, AD_PHYS, 4, 8),
          ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_CLAW, AD_PHYS, 4, 4),
          ATTK(AT_ENGL, AD_DGST, 2, 10), ATTK(AT_NONE, AD_COLD, 0, 6)),
    ...
    MON("green dragon", S_DRAGON, LVL(15, 9, -1, 20, 6), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_DRST, 4, 6), ATTK(AT_BITE, AD_PHYS, 4, 8),
          ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_CLAW, AD_PHYS, 4, 4),
          ATTK(AT_ENGL, AD_DGST, 2, 10), ATTK(AT_NONE, AD_DRST, 0, 2)),
    ...
    MON("gnome lady", S_GNOME, LVL(3, 8, 10, 4, 0), (G_GENO | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(700, 120, MS_HUMANOID, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
        M2_LORD | M2_FEMALE | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, MH_GNOME, 4, CLR_BLUE),
    ...
    MON("gnome queen", S_GNOME, LVL(5, 10, 10, 20, 0), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(750, 150, MS_HUMANOID, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
        M2_PRINCE | M2_FEMALE | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE | M3_INFRAVISION, 0, MH_GNOME, 6, HI_LORD),
#ifdef SPLITMON_1
};
#endif
...
struct permonst _mons2[] = {
    ...
    MON("fire giant", S_GIANT, LVL(9, 12, 4, 5, 2), (G_GENO | G_SGROUP | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, M4_VULNERABLE_COLD, MH_GIANT, 11, CLR_YELLOW),
    MON("frost giant", S_GIANT, LVL(10, 12, 3, 10, -3),
        ...
        M1_HUMANOID | M1_CARNIVORE, M2_STRONG | M2_ROCKTHROW | M2_NASTY
            | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION, M4_VULNERABLE_FIRE, MH_GIANT, 13, CLR_WHITE),
    MON("ettin", S_GIANT, LVL(10, 12, 3, 0, 0), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, 0, 13, CLR_BROWN),
    MON("storm giant", S_GIANT, LVL(16, 12, 3, 10, -3),
        ...
        M1_HUMANOID | M1_CARNIVORE, M2_STRONG | M2_ROCKTHROW | M2_NASTY
            | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, MH_GIANT, 19, CLR_BLUE),
   ...
   MON("snark", S_JABBERWOCK,
    ...
    MON("kobold mummy", S_MUMMY, LVL(3, 8, 6, 20, -2),
        ...
        M2_HOSTILE, M3_INFRAVISION, M4_VULNERABLE_FIRE, MH_UNDEAD, 4, CLR_BROWN),
    ...
    MON("ogre", S_OGRE, LVL(5, 10, 5, 0, -3), (G_SGROUP | G_GENO | 1),
        ...
        M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, MH_OGRE, 7, CLR_BROWN),
    ...
    MON("ogre lady", S_OGRE, LVL(7, 12, 3, 30, -5), (G_GENO | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1700, 700, MS_GRUNT, MZ_LARGE), 0, 0, M1_HUMANOID | M1_CARNIVORE,
        M2_STRONG | M2_LORD | M2_FEMALE | M2_GREEDY | M2_JEWELS | M2_COLLECT,
    ...
    MON("ogre queen", S_OGRE, LVL(9, 14, 4, 60, -7), (G_GENO | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 5), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1700, 750, MS_GRUNT, MZ_LARGE), 0, 0, M1_HUMANOID | M1_CARNIVORE,
        M2_STRONG | M2_PRINCE | M2_FEMALE | M2_GREEDY | M2_JEWELS | M2_COLLECT,
    ...
    MON("Vlad the Impaler", S_VAMPIRE, LVL(28, 26, -6, 80, -10),
        ...
        M4_VULNERABLE_FIRE, MH_UNDEAD, 32, HI_LORD),
    /*
     * Wraiths
     */
    MON("barrow wight", S_WRAITH, LVL(3, 12, 5, 5, -3),
        ...
        M4_VULNERABLE_FIRE, MH_UNDEAD, 7, CLR_GRAY),
    ...
    MON("kobold zombie", S_ZOMBIE, LVL(0, 2, 10, 0, -3),
        ...
        M4_VULNERABLE_FIRE, MH_UNDEAD, 1, CLR_BROWN),
    ...
    MON("giant zombie", S_ZOMBIE, LVL(8, 5, 6, 0, -4),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_DRCO, 2, 8), ATTK(AT_CLAW, AD_DRCO, 1, 10),
          ATTK(AT_BITE, AD_DRIN, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2050, 375, MS_SILENT, MZ_HUGE), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
    ...
    MON("elf", S_HUMAN, LVL(10, 12, 10, 2, -3), G_NOGEN, /* for corpses */
        ...
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_ELF, 12, HI_DOMESTIC),
    ...
    MON("elf-lady", S_HUMAN, LVL(8, 12, 10, 20, -9), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
        M2_STRONG | M2_LORD | M2_FEMALE | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE | M3_INFRAVISION, 0,
        MH_ELF, 11, CLR_BRIGHT_BLUE),
    MON("elven wizard", S_HUMAN, LVL(9, 12, 10, 25, -10), (G_GENO | 1),
        A(ATTK(AT_MAGC, AD_SPEL, 0, 0), ATTK(AT_MAGC, AD_MAGM, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
        ...
        M3_ACCURATE | M3_INFRAVISIBLE | M3_INFRAVISION, 0,
        MH_ELF, 11, CLR_BRIGHT_BLUE),
    MON("elven king", S_HUMAN, LVL(9, 12, 10, 25, -10), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
        ...
        M3_ACCURATE | M3_INFRAVISIBLE | M3_INFRAVISION, 0,
        MH_ELF, 11, HI_LORD),
    MON("elven queen", S_HUMAN, LVL(9, 12, 10, 25, -10), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
        M2_STRONG | M2_PRINCE | M2_FEMALE | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE | M3_INFRAVISION, 0,
        MH_ELF, 11, HI_LORD),
    ...
    MON("human soldier", S_HUMAN, LVL(6, 10, 10, 0, -2), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("elven soldier", S_HUMAN, LVL(6, 10, 10, 0, -2), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_ELF, 350, MS_SOLDIER, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_ELF, 8, CLR_GRAY),
    MON("dwarvish soldier", S_HUMAN, LVL(6, 10, 10, 0, -2), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(900, 300, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_DWARF, 8, CLR_GRAY),
    MON("gnomish soldier", S_HUMAN, LVL(6, 10, 10, 0, -2), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(650, 100, MS_SOLDIER, MZ_SMALL), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_GNOME, 8, CLR_GRAY),
    MON("orcish soldier", S_HUMAN, LVL(6, 10, 10, 0, -2), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(850, 150, MS_SOLDIER, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_ORC, 8, CLR_GRAY),
    MON("giant soldier", S_HUMAN, LVL(6, 10, 10, 0, -2), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(2250, 750, MS_SOLDIER, MZ_HUGE), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_ROCKTHROW,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_GIANT, 8, CLR_GRAY),
    MON("centaurian soldier", S_HUMAN, LVL(6, 10, 10, 0, -2), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(2500, 500, MS_SOLDIER, MZ_LARGE), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE | M3_SKITTISH, 0, MH_CENTAUR, 8, CLR_GRAY),
    MON("human sergeant", S_HUMAN, LVL(8, 10, 10, 5, -3), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
    ...
    MON("elven sergeant", S_HUMAN, LVL(8, 10, 10, 5, -3), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_ELF, 350, MS_SOLDIER, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_ELF, 10, CLR_RED),
    MON("dwarvish sergeant", S_HUMAN, LVL(8, 10, 10, 5, -3), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(900, 300, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_DWARF, 10, CLR_RED),
    MON("gnomish sergeant", S_HUMAN, LVL(8, 10, 10, 5, -3), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(650, 100, MS_SOLDIER, MZ_SMALL), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_GNOME, 10, CLR_RED),
    MON("orcish sergeant", S_HUMAN, LVL(8, 10, 10, 5, -3), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(850, 150, MS_SOLDIER, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_ORC, 10, CLR_RED),
    MON("giant sergeant", S_HUMAN, LVL(8, 10, 10, 5, -3), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(2250, 750, MS_SOLDIER, MZ_HUGE), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_ROCKTHROW,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_GIANT, 10, CLR_RED),
    MON("centaurian sergeant", S_HUMAN, LVL(8, 10, 10, 5, -3), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(2500, 500, MS_SOLDIER, MZ_LARGE), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE | M3_SKITTISH, 0, MH_CENTAUR, 10, CLR_RED),
    ...
    MON("human lieutenant", S_HUMAN, LVL(10, 10, 10, 15, -4), (G_GENO | 1),
    ...
    MON("elven lieutenant", S_HUMAN, LVL(10, 10, 10, 15, -4), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 4), ATTK(AT_WEAP, AD_PHYS, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_SOLDIER, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_ELF, 12, CLR_GREEN),
    MON("dwarvish lieutenant", S_HUMAN, LVL(10, 10, 10, 15, -4), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 4), ATTK(AT_WEAP, AD_PHYS, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(900, 300, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_DWARF, 12, CLR_GREEN),
    MON("gnomish lieutenant", S_HUMAN, LVL(10, 10, 10, 15, -4), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 4), ATTK(AT_WEAP, AD_PHYS, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(650, 100, MS_SOLDIER, MZ_SMALL), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_GNOME, 12, CLR_GREEN),
    MON("orcish lieutenant", S_HUMAN, LVL(10, 10, 10, 15, -4), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 4), ATTK(AT_WEAP, AD_PHYS, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(850, 150, MS_SOLDIER, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_ORC, 12, CLR_GREEN),
    MON("giant lieutenant", S_HUMAN, LVL(10, 10, 10, 15, -4), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 4), ATTK(AT_WEAP, AD_PHYS, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2250, 750, MS_SOLDIER, MZ_HUGE), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_ROCKTHROW,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_GIANT, 12, CLR_GREEN),
    MON("centaurian lieutenant", S_HUMAN, LVL(10, 10, 10, 15, -4), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 4), ATTK(AT_WEAP, AD_PHYS, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2500, 500, MS_SOLDIER, MZ_LARGE), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE | M3_SKITTISH, 0, MH_CENTAUR, 12, CLR_GREEN),
    MON("human captain", S_HUMAN, LVL(12, 10, 10, 15, -5), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
    ...
    MON("elven captain", S_HUMAN, LVL(12, 10, 10, 15, -5), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_SOLDIER, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_ELF, 14, CLR_BLUE),
    MON("dwarvish captain", S_HUMAN, LVL(12, 10, 10, 15, -5), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(900, 300, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_DWARF, 14, CLR_BLUE),
    MON("gnomish captain", S_HUMAN, LVL(12, 10, 10, 15, -5), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 100, MS_SOLDIER, MZ_SMALL), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_GNOME, 14, CLR_BLUE),
    MON("giant captain", S_HUMAN, LVL(12, 10, 10, 15, -5), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2250, 750, MS_SOLDIER, MZ_HUGE), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_ROCKTHROW,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE, 0, MH_GIANT, 14, CLR_BLUE),
    ...
    MON("Wizard of Yendor", S_HUMAN, LVL(30, 12, -8, 100, A_NONE),
        (G_NOGEN | G_UNIQ),
        A(ATTK(AT_CLAW, AD_SAMU, 2, 12), ATTK(AT_WEAP, AD_PHYS, 2, 8),
        ...
        M2_NOPOLY | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_PRINCE
            | M2_MALE | M2_MAGIC,
        M3_COVETOUS | M3_WAITFORU | M3_INFRAVISIBLE, 0, MH_HUMAN, 34, CLR_BRIGHT_MAGENTA),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("balrog", S_DEMON, LVL(16, 5, -2, 75, -14), (G_HELL | G_NOCORPSE | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, MH_DEMON, 20, CLR_RED),
     ...
     *
     * Profiles wrapped with #if 0, will revisit
     * those at another time.
     */
    MON("human archeologist", S_HUMAN, LVL(10, 15, 10, 1, 3), (1),
    ...
    MON("human barbarian", S_HUMAN, LVL(10, 15, 10, 1, -3), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_SAMU, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("human cavewoman", S_HUMAN, LVL(10, 15, 10, 0, 1), (1),
        ...
        M3_INFRAVISIBLE, 0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human healer", S_HUMAN, LVL(10, 12, 10, 1, 0), (1),
    ...
    MON("human priestess", S_HUMAN, LVL(10, 12, 10, 2, -2), (1),
        ...
        M2_NOPOLY | M2_STRONG | M2_FEMALE | M2_COLLECT,
        M3_INFRAVISIBLE, 0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human ranger", S_HUMAN, LVL(10, 12, 10, 2, -3), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 4), ATTK(AT_WEAP, AD_SAMU, 1, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE | M3_SKITTISH,
        0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human rogue", S_HUMAN, LVL(10, 12, 10, 1, -3), (1),
        A(ATTK(AT_WEAP, AD_SAMU, 1, 6), ATTK(AT_WEAP, AD_SITM, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE, 0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human samurai", S_HUMAN, LVL(10, 15, 10, 1, 3), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_SAMU, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human tourist", S_HUMAN, LVL(10, 12, 10, 1, 0), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_SAMU, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human valkyrie", S_HUMAN, LVL(10, 15, 10, 1, 1), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_SAMU, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        M2_NOPOLY | M2_STRONG | M2_FEMALE | M2_COLLECT,
        M3_INFRAVISIBLE, 0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human wizard", S_HUMAN, LVL(10, 12, 10, 3, 0), (1),
        A(ATTK(AT_WEAP, AD_SAMU, 1, 6), ATTK(AT_MAGC, AD_SPEL, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("barbarian", S_HUMAN, LVL(10, 12, 10, 1, -3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("rogue", S_HUMAN, LVL(10, 12, 10, 1, -3), G_NOGEN,
        ...
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISIBLE, 0, MH_HUMAN, 12, HI_DOMESTIC),
