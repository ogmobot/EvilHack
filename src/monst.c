...
NEARDATA struct permonst mons[] = {
    ...
    MON("mumak", S_QUADRUPED, LVL(10, 9, 0, 0, -2), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE, 0, 0, 12, CLR_GRAY),
    ...
    MON("woolly mammoth", S_QUADRUPED, LVL(24, 10, 2, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BUTT, AD_PHYS, 6, 6), ATTK(AT_BUTT, AD_PHYS, 6, 6),
    ...
    MON("baby sea dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 3, 8), ATTK(AT_CLAW, AD_PHYS, 2, 4),
          ...
          NO_ATTK, NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), 0, 0,
        M1_SWIM | M1_AMPHIBIOUS | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS,
    ...
    MON("sea dragon", S_DRAGON, LVL(15, 9, -1, 20, -4), (G_GENO | 1),
...
struct permonst _mons2[] = {
   ...
   MON("snark", S_JABBERWOCK, LVL(12, 18, 0, 30, 0), (G_GENO | 2),
    ...
    MON("vampire lady", S_VAMPIRE, LVL(12, 14, 0, 50, -9),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 8), ATTK(AT_BITE, AD_DRLI, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_VAMPIRE, MZ_HUMAN), MR_SLEEP | MR_POISON, 0,
        M1_FLY | M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
        M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_LORD
            | M2_FEMALE | M2_SHAPESHIFTER,
        M3_INFRAVISIBLE, M4_VULNERABLE_FIRE, MH_UNDEAD, 14, CLR_BLUE),
    MON("vampire king", S_VAMPIRE, LVL(16, 18, -2, 50, -9),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("vampire queen", S_VAMPIRE, LVL(16, 18, -2, 50, -9),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 6), ATTK(AT_BITE, AD_DRLI, 1, 10), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_VAMPIRE, MZ_HUMAN), MR_SLEEP | MR_POISON, 0,
...
#ifdef MINIGAME
    MON("gambler", S_HUMAN, LVL(12, 12, 10, 0, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GAME, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 0, MH_HUMAN, 14, CLR_BLACK),
#endif
    ...
    MON("dwarvish soldier", S_HUMAN, LVL(6, 10, 10, 0, -2), (G_SGROUP | G_GENO | 1),
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
            | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_ACCURATE | M3_INFRAVISION | M3_INFRAVISIBLE | M3_BERSERK,
        0, MH_DWARF, 8, CLR_GRAY),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("Orcus", S_DEMON, LVL(66, 9, -6, 85, -20),
        ...
        M3_WAITFORU | M3_WANTSBOOK | M3_WANTSAMUL | M3_INFRAVISIBLE
            | M3_INFRAVISION, 0,
        MH_DEMON, 36, HI_LORD),
    MON("Geryon", S_DEMON, LVL(72, 9, -3, 75, 15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 3, 6),
    ...
    MON("human barbarian", S_HUMAN, LVL(10, 15, 10, 1, -3), (1),
        ...
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE | M3_BERSERK,
    ...
    MON("human cavewoman", S_HUMAN, LVL(10, 15, 10, 0, 1), (1),
        ...
        M3_INFRAVISIBLE, 0, MH_HUMAN, 12, CLR_YELLOW),
    MON("human convict", S_HUMAN, LVL(10, 12, 10, 1, 0), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_SAMU, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("human ranger", S_HUMAN, LVL(10, 12, 10, 2, -3), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 4), ATTK(AT_WEAP, AD_SAMU, 1, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT,
    ...
    MON("human rogue", S_HUMAN, LVL(10, 12, 10, 1, -3), (1),
        A(ATTK(AT_WEAP, AD_SAMU, 1, 6), ATTK(AT_WEAP, AD_SITM, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
    ...
    MON("human samurai", S_HUMAN, LVL(10, 15, 10, 1, 3), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_SAMU, 1, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
