...
WEAPON("elven long sword", "runed long sword",
       0, 0, 0, 10,  35,  40, 10, 12, 0, S,   P_LONG_SWORD, WOOD, HI_WOOD),
...
WEAPON("lance", None,
       1, 0, 0,  4, 180,  10,  6,  8, 0, P,   P_LANCE, METAL, HI_METAL),
...
WEAPON("staff of divination", "wormwood staff",
       0, 0, 1,  5,  40, 400,  6,  6, 0, B,   P_QUARTERSTAFF, WOOD, HI_WOOD),
WEAPON("staff of healing", "twisted staff",
       0, 0, 1,  5,  40, 400,  6,  6, 0, B,   P_QUARTERSTAFF, WOOD, HI_WOOD),
WEAPON("staff of holiness", "bone-carved staff",
       0, 0, 1,  5,  40, 400,  6,  6, 0, B,   P_QUARTERSTAFF, BONE, CLR_WHITE),
WEAPON("staff of matter", "etched staff",
       0, 0, 1,  5,  30, 450,  6,  6, 0, B,   P_QUARTERSTAFF, MITHRIL, HI_SILVER),
WEAPON("staff of escape", "darkwood staff",
       0, 0, 1,  5,  40, 400,  6,  6, 0, B,   P_QUARTERSTAFF, WOOD, CLR_BLACK),
WEAPON("staff of war", "ironshod staff",
       0, 0, 1,  5,  50, 425,  6,  6, 2, B,   P_QUARTERSTAFF, IRON, HI_METAL),
/* two-piece */
...
ARMOR("crystal plate mail", None,
      1, 0, 1,  0,  8, 5, 150, 5000, 3, 2,  ARM_SUIT, GEMSTONE, CLR_WHITE),
ARMOR("splint mail", None,
      1, 0, 1,  0, 57, 5, 300,  80,  4, 1,  ARM_SUIT, IRON, HI_METAL),
ARMOR("banded mail", None,
      1, 0, 1,  0, 67, 5, 250,  90,  4, 1,  ARM_SUIT, IRON, HI_METAL),
ARMOR("chain mail", None,
      1, 0, 0,  0, 72, 5, 200,  75,  5, 1,  ARM_SUIT, IRON, HI_METAL),
ARMOR("dwarvish chain mail", None,
      1, 0, 0,  0, 12, 1, 200,  75,  4, 3,  ARM_SUIT, IRON, HI_METAL),
ARMOR("elven chain mail", None,
      1, 0, 0,  0, 15, 1, 200,  75,  5, 3,  ARM_SUIT, COPPER, HI_COPPER),
...
ARMOR("studded armor", None,
      1, 0, 0,  0, 72, 3, 125,  15,  7, 1,  ARM_SUIT, LEATHER, HI_LEATHER),
...
RING("mind shielding", "mithril",
     PSYCHIC_RES,              150, 1, 0,  3, MITHRIL,  HI_SILVER),
...
AMULET("amulet of flying",            "trapezoid", FLYING, 95),
...
SPELL("magic missile",   "vellum",
      P_ATTACK_SPELL,      40,  2, 2, 1, RAY, HI_LEATHER),
...
SPELL("sleep",           "mottled",
      P_ENCHANTMENT_SPELL, 40,  1, 2, 1, RAY, HI_PAPER),
...
SPELL("poison blast",    "olive green",
      P_ATTACK_SPELL,       8,  9, 5, 1, RAY, CLR_GREEN),
SPELL("acid blast",      "acid green",
      P_ATTACK_SPELL,       8,  9, 6, 1, RAY, CLR_BRIGHT_GREEN),
SPELL("psionic wave",    "worn",
      P_ATTACK_SPELL,       0,  1, 1, 1, IMMEDIATE, CLR_MAGENTA),
SPELL("light",           "cloth",
      P_DIVINATION_SPELL,  40,  1, 1, 1, NODIR, HI_CLOTH),
SPELL("detect monsters", "leathery",
      P_DIVINATION_SPELL,  43,  1, 3, 1, NODIR, HI_LEATHER),
SPELL("healing",         "white",
...
WAND("alteration",    "mithril", 50, 150, 1, IMMEDIATE, MITHRIL, HI_SILVER),
