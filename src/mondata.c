...
static const short grownups[][2] = {
    ...
    { PM_HUMAN_SOLDIER, PM_HUMAN_SERGEANT },
    { PM_ELVEN_SOLDIER, PM_ELVEN_SERGEANT },
    { PM_DWARVISH_SOLDIER, PM_DWARVISH_SERGEANT },
    { PM_GNOMISH_SOLDIER, PM_GNOMISH_SERGEANT },
    { PM_ORCISH_SOLDIER, PM_ORCISH_SERGEANT },
    { PM_CENTAURIAN_SOLDIER, PM_CENTAURIAN_SERGEANT },
    { PM_GIANT_SOLDIER, PM_GIANT_SERGEANT },
    { PM_HUMAN_SERGEANT, PM_HUMAN_LIEUTENANT },
    { PM_ELVEN_SERGEANT, PM_ELVEN_LIEUTENANT },
    { PM_DWARVISH_SERGEANT, PM_DWARVISH_LIEUTENANT },
    { PM_GNOMISH_SERGEANT, PM_GNOMISH_LIEUTENANT },
    { PM_ORCISH_SERGEANT, PM_ORCISH_LIEUTENANT },
    { PM_CENTAURIAN_SERGEANT, PM_CENTAURIAN_LIEUTENANT },
    { PM_GIANT_SERGEANT, PM_GIANT_LIEUTENANT },
    { PM_HUMAN_LIEUTENANT, PM_HUMAN_CAPTAIN },
    { PM_ELVEN_LIEUTENANT, PM_ELVEN_CAPTAIN },
    { PM_DWARVISH_LIEUTENANT, PM_DWARVISH_CAPTAIN },
    { PM_GNOMISH_LIEUTENANT, PM_GNOMISH_CAPTAIN },
    { PM_GIANT_LIEUTENANT, PM_GIANT_CAPTAIN },
    { PM_WATCHMAN, PM_WATCH_CAPTAIN },
    { PM_ALIGNED_PRIEST, PM_HIGH_PRIEST },
    { PM_STUDENT, PM_HUMAN_ARCHEOLOGIST },
    { PM_ATTENDANT, PM_HUMAN_HEALER },
    { PM_PAGE, PM_HUMAN_KNIGHT },
    { PM_ACOLYTE, PM_HUMAN_PRIESTESS },
    { PM_APPRENTICE, PM_HUMAN_WIZARD },
    { PM_MANES, PM_LEMURE },
