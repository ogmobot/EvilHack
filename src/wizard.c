...
static NEARDATA const int nasties[] = {
    ...
    /* chaotic */
    PM_BLACK_DRAGON, PM_RED_DRAGON, PM_LICH, PM_VAMPIRE_LORD,
    PM_MASTER_MIND_FLAYER, PM_DISENCHANTER, PM_WINGED_GARGOYLE,
    PM_STORM_GIANT, PM_OLOG_HAI, PM_ELF_LORD, PM_ELVEN_KING,
    PM_OGRE_KING, PM_HUMAN_CAPTAIN, PM_GREMLIN, PM_HILL_GIANT_SHAMAN,
    PM_ELF_LADY, PM_ELVEN_QUEEN, PM_OGRE_QUEEN,
    /* lawful */
...
static NEARDATA const unsigned wizapp[] = {
    ...
    PM_ROCK_TROLL, PM_UMBER_HULK,   PM_XORN,          PM_XAN,
    PM_BASILISK,   PM_FLOATING_EYE, PM_GUARDIAN_NAGA, PM_TRAPPER,
};
